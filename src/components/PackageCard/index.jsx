...
import { Clock, Calendar, MapPin, Film, Star } from "lucide-react";
  ...
  return (
    <div className="flex flex-col bg-white shadow-md overflow-hidden w-full mx-auto">
      ...
      <div className="relative h-80 w-full">
        <Image src={tour.imagePath || "/images/venezia.jpg"} alt={tour.title} fill className="object-cover" />
      </div>
      ...
      <div className="flex flex-col xl:flex-row xl:justify-between gap-6 p-5 xl:p-8">
        <div className="flex flex-col gap-4">
          {/* Title */}
          <h2 className="text-xl font-bold text-gray-800 uppercase">{tour.title}</h2>
