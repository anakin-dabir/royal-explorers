...
import { Star, ChevronLeft, ChevronRight, Clock, ArrowLeft, ArrowRight } from "lucide-react";
      ...
      <div className="relative container mx-auto max-w-7xl py-12 px-8">
        ...
        <div ref={sliderRef} className="keen-slider flex h-full flex-1">
          {tourPackages.map((tour, index) => (
            <div key={`${tour.id}-${index}`} className="keen-slider__slide flex flex-col shadow-lg bg-white flex-1 h-full hover:shadow-2xl relative">
              {/* Image */}
              <div>
